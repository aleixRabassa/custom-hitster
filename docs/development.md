...
every index move (2026-09-19), and the movement it hands the card's own `movement` prop beside it
(2026-09-21). What they cannot cover is a service worker, a browser's download behaviour, a laid-out
screen, a stacking order and a thumb.

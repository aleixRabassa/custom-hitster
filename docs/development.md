...
(2026-09-21), and the `pt-8` the two screens now share, asserted at both ends (2026-09-21). What they
cannot cover is a service worker, a browser's download behaviour, a laid-out screen, a stacking order
and a thumb.
